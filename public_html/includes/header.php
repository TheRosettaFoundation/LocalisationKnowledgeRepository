...
<head>
	...
	<script type="text/javascript" src="./resources/js/jquery.qtip.js"></script>
	<?php 
...
<div id="body_wrapper">
	<div id="header">
		<a href="http://www.cngl.ie/"><img id="cngl" src="./resources/images/cngl.jpg" width="110" height="40" alt="CNGL" /></a>
		<div><h1><a href="./">Localisation Knowledge Repository (LKR)</a></h1></div>
		<?php
		...
		{
		?>
			<p align="right"><a href="./author/">Author Central</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<a href="./pm/">Log in as Project Manager</a></p>
		<?php
		}
		?>
	</div>
